      ...
      >
        <div className='space-y-6 p-6 text-lg text-muted-foreground sm:p-8'>
          ...
          <p>
            ...
            hands-on curiosity slowly turned into a love for making things with
            code. Over time, I moved from robots and gadgets to websites and
            apps, always chasing the next challenge. Since then, I've spent
            countless hours coding, brainstorming, and wrestling with bugs that
            taught me a lot more than any tutorial ever could.
          </p>
          <Link
            className={cn(
