...
export const Header = ({ page, tags }: HeaderProps) => {
  ...
  return (
    <Section>
      <FrameDecoration />
      <div className='relative h-[280px] overflow-clip md:h-[420px] lg:h-[600px]'>
        <div className='relative flex h-full w-full flex-col justify-end overflow-hidden rounded-2xl bg-primary/80 shadow-xl'>
          ...
          >
            ...
            <div className='mb-4 space-y-4 text-balance'>
              ...
              <p className='typography-body hidden max-w-3xl text-pretty text-zinc-100 leading-8 md:block dark:text-foreground/85'>
                {page.data.description ?? ''}
              </p>
            </div>
            <div className='flex items-center gap-6 text-xs text-zinc-200 dark:text-foreground/45'>
