...
const FrameDecoration = () => (
  <>
    ...
    <span className='absolute top-12 left-[44.5px] z-10 hidden h-px w-2 bg-white md:block' />
    <span className='absolute top-[44.5px] left-[48px] z-10 hidden h-2 w-px bg-white md:block' />
    <span className='absolute top-12 right-[44.5px] z-10 hidden h-px w-2 bg-white md:block' />
    <span className='absolute top-[44.5px] right-[48px] z-10 hidden h-2 w-px bg-white md:block' />
    <span className='absolute bottom-12 left-[44.5px] z-10 hidden h-px w-2 bg-white md:block' />
    <span className='absolute bottom-[44.5px] left-[48px] z-10 hidden h-2 w-px bg-white md:block' />
    <span className='absolute right-[44.5px] bottom-12 z-10 hidden h-px w-2 bg-white md:block' />
    <span className='absolute right-[48px] bottom-[44.5px] z-10 hidden h-2 w-px bg-white md:block' />
  </>
)
