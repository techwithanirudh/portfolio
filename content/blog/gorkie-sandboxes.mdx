...
Vercel recently launched a [Chat SDK](https://chat-sdk.dev/) that supports multiple runtimes. We're looking at whether a future version of Gorkie makes sense on top of it.
