---
title: "How We Taught a Slack Bot to Run Code"
description: Teaching a Slack bot to run code safely, by way of Vercel Sandboxes, E2B, and finally Daytona.
date: 2026-02-25
tags: ['ai', 'tech', 'infrastructure']
image: /images/blog/gorkie-sandboxes.jpg
...
Vercel recently launched a [Chat SDK](https://chat-sdk.dev/) that supports multiple runtimes. We might rewrite Gorkie on top of it.
