...
* [Coder](https://marketplace.visualstudio.com/items?itemName=Coder.coder)
* [Codex](https://github.com/openai/codex)
* [Cursor Midnight Theme (Muhammad Zaid)](https://marketplace.visualstudio.com/items?itemName=muhammadzaid.cursor-midnight-theme)
